...
\input{slides/systeme_1_intro}

\subsection{Manipulation de fichiers et répertoires}
\input{slides/systeme_2_fichiers}
\input{slides/systeme_3_cat}
\input{slides/systeme_4_rm_ln_mkdir_ls}

\subsection{Processus Unix }
\input{slides/systeme_4.5_processus_cwd_fork_shell_loop}
\input{slides/systeme_5_redirection_tube}

\subsection{Interlude réseau}
\input{slides/systeme_6_réseau}

\subsection{Programmation système haut niveau}
\input{slides/systeme_7_en_vrai}

\subsection{Concurrence en OCaml}
\input{slides/systeme_8_concurrence}
...
\input{slides/irl_0_intro}
\subsection{Mirage}
\input{slides/irl_1_mirage}
\subsection{OCaml 5}
\input{slides/irl_2_ocaml_5}
\subsection{Vérification de propriétés avec QCheck}
\input{slides/irl_3_qcheck}
